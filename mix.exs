defmodule MobSms.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      aliases: aliases(),
      description:
        "SMS composer (pre-fill + user-confirm send) for Mob apps — MFMessageComposeViewController on iOS, ACTION_SENDTO on Android",
      package: package(),
      docs: [
        main: "readme",
  ...
  defp package do
    [
      ...
      # native build compiles them from deps/mob_sms/priv/.
